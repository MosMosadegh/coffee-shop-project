...
export default function Page() {
  ...
  return (
    <div className="container h-[800px] flex flex-col justify-center items-center bg-black text-white">
      <div className="relative w-[400px] h-auto z-[0]">
        ...
        <div>
          <form
            ...
            className="py-12 px-9 bg-white/10 border-2 border-slate-700 rounded-xl backdrop-blur-sm shadow-lg shadow-gray-900"
          >
            <h1 className="text-3xl text-center mb-7">Enter The Key</h1>
